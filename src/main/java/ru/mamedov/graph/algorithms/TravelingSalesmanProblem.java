...
public class TravelingSalesmanProblem {
    ...
    public static void nearestNeighbor(AdjacencyListGraph graph,
                                       ConsumerWithException<Edge> onUnvisitedEdge,
        ...
        nn(graph, startingNode, startingNode, visitedNodes, onUnvisitedEdge, onVisitedNode, onVisitedEdge, onProcessedNode, isCanceled);
    }

    private static boolean nn(AdjacencyListGraph graph,
                              Node current,
                              Node startingNode,
                              Set<Node> visitedNodes,
                              ConsumerWithException<Edge> onUnvisitedEdges,
                              ConsumerWithException<Node> onVisitedNode,
                              ConsumerWithException<Edge> onVisitedEdge,
                              Consumer<Node> onProcessedNode,
                              Boolean isCanceled) throws Exception {
    ...
    public static void twoOpt(AdjacencyListGraph graph,
                              ConsumerWithException<Edge> onUnvisitedEdge,
                              ConsumerWithException<Node> onVisitedNode,
                              ConsumerWithException<Edge> onVisitedEdge,
                              Consumer<Node> onProcessedNode,
    ...
    private static boolean firstValidRoute(AdjacencyListGraph graph,
                                           Node current,
                                           Node startingNode,
                                           List<Node> path) {
