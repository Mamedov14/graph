...
public class ConnectedComponents {
    ...
    public static void connectedComponents(AdjacencyListGraph graph,
                                           ConsumerWithException<Node> visitNode,
                                           ConsumerWithException<Edge> visitEdge,
                                           Consumer<Node> processNode,
    ...
    private static void bfs(ConsumerWithException<Node> onVisitedNode,
                            ...
                            Node startingNode,
                            boolean isCanceled,
                            Color edgeColor) throws Exception {
