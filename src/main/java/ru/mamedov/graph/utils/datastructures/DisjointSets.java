...
public class DisjointSets {
    ...
    private final List<DisjointSet> sets = new ArrayList<>();
    ...
    public Node find(Node node) {
        ...
        return optionalSet.map(disjointSet -> disjointSet.representative).orElse(null);
    }
    ...
    public static class DisjointSet {
        ...
        public boolean equals(Object o) {
            ...
            if (!Objects.equals(representative, that.representative)) {
                return false;
            }
